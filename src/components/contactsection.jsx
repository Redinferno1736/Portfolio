        ...
        <section className="pt-36 pb-20 w-full flex justify-center " id="contact">
            <div className="w-full max-w-6xl px-4 flex flex-col md:flex-row items-center md:items-stretch gap-10 md:gap-16">
                ...
                <div className="flex-1 flex flex-col justify-center md:order-1 order-2 max-w-xl">
                    ...
                    <motion.p className="text-base md:text-lg text-gray-300 mb-8"
                    ...
                    {/* SOCIAL LINKS */}
                    <div className="flex gap-8 mt-8 items-center md:justify-start justify-center">
                        <motion.a
                            href="mailto:your@email.com"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="transition-colors text-gray-300 hover:text-[#137062] text-2xl"
                            whileHover={{ scale: 1.2, color: "#3fd7c8" }}
                        >
                            <MdEmail />
                        </motion.a>
                        <motion.a
                ...
                <div className="flex-1 flex flex-col justify-center md:order-2 order-1">
                    ...
                    <motion.form
                        className="flex flex-col gap-4 bg-[#181c1f] rounded-xl p-6 shadow-xl shadow-[#2c3237] border-none mt-20 md:mt-32"
                    ...
                    >
                        <div className="flex flex-col gap-2">
                            <label className="text-[#B0B7B5] font-medium text-lg">Name</label>
                            <input
                                required
                                type="text"
                                name="name"
                                className="rounded px-4 py-2 bg-[#292e32] text-white border border-none focus:outline-none focus:border-[#3fd7c8] transition"
                            />
                        </div>
                        <div className="flex flex-col gap-2">
                            <label className="text-[#B0B7B5] font-medium text-lg">Email</label>
                            <input
                                required
                                type="email"
                                name="email"
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-[#B0B7B5] font-medium text-lg">Message</label>
                            <textarea
                                required
                                name="message"
                                rows={4}
                                className="rounded px-4 py-2 bg-[#292e32] text-white border border-none focus:outline-none focus:border-[#3fd7c8] transition resize-none"
                            />
                        </div>
                        <motion.button
                            whileHover={{
